...
class VetAdapter (private var vetList: VetResponse, private val context: Context):
    ...
    class VetViewHolder (itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val veterinaryNumberOfRate: TextView = itemView.findViewById(R.id.number_of_rate_veterinary_tv)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VetViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.veterinary_nearby_item, parent, false)
        return VetAdapter.VetViewHolder(itemView)
    }
